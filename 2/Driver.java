...
public class Driver {
    ...
    static
    {
        ...
        Book ob3 = new Book("t3", "a3", "p3", 800);
        Book ob4 = new Book("t4", "a4", "p4", 300);
        Book ob5 = new Book("t5", "a4", "p5", 200);
    ...
    public static void searchByTitleandReplacePublisher() {
    ...
    private static void detailsByAuthorName() {
        System.out.println("Getting details by Author name");
